package ru.goddriver.aoc2018.day2;
...
public class solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Part Two
        System.out.println("Common letters between the two correct box IDs are " + getCommonLetters(fileName));
    }

    public static int getChecksum(String fileName) throws Exception {
    ...
    public static String getCommonLetters(String fileName) throws Exception {
        Scanner scanner = new Scanner(new BufferedReader(new FileReader(fileName)));
