package ru.goddriver.exercises.aoc2018.day1;
...
public class solution {
    ...
    private static int getResultingFrequency(String fileName) throws Exception{
    ...
    private static int getFirstFrequencyReachesTwice(String fileName) throws Exception {
        Scanner scanner = new Scanner(new BufferedReader(new FileReader(fileName)));
        int freq = 0;
